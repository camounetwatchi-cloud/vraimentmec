...
def generate_fen_position(negative_min=-99, negative_max=-15, positive_min=15, positive_max=99, material_diff=3, max_material=22, max_attempts=20000, excluded_pieces=None):
